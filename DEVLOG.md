...
## Entry 6 – May 14: Clean up

_Cleaned up the entire repo prior to submission. Removed all blockquotes in README and DEVLOG, cleaned up explination functions in torchbearer file for better reading clarity when those are ran. Double checked names and fixed comment formatting. Filled out time estimates for devlog._
...
| Part 3: Algorithm Correctness | .75 |
